...
std::expected<void, std::string> scenes::test::startup(entt::registry& registry, Renderer& renderer) {
...
std::expected<void, std::string> scenes::test::update(entt::registry& reg, Renderer& renderer) {
  return {};
}
